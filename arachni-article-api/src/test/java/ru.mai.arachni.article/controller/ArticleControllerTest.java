...
import ru.mai.arachni.article.configuration.ArticleConfiguration;
...
@ContextConfiguration(classes = {ArticleController.class, ArticleConfiguration.class})
public class ArticleControllerTest {
    ...
    private PaginationResponse<ArticlePreviewResponse> expectedArticleListResponse;
    ...
    private void initExpectedResponses() {
        ...
        expectedArticleListResponse = new PaginationResponse<>(
    ...
    void testGetArticleListResponse() throws Exception {
        ...
        ArticleListRequest request = ArticleListRequest
                ...
                .build();
        when(articleService.getArticlePreviewList(request))
